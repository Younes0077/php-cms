<?php
    ...
    if ($state == 1) {
        $sql = "INSERT INTO experience(title,subtitle,content,fromDate,toDate) VALUES('$title','$subtitle','$content','$fromDate','$toDate')";
        $conn->query($sql);
            ...
            <div class="row p-3">
                <div class="col-12 col-sm-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="fromDate" name="fromDate"  aria-describedby="emailHelp" placeholder="enter from date...">
                    </div>
                </div>
                <div class="col-12 col-sm-5">
                    <div class="form-group">
                        <label>to date:</label>
                        <input type="text" class="form-control form-control-user" id="toDate" name="toDate"  aria-describedby="emailHelp" placeholder="enter to date...">
                    </div>
                </div>
            </div>
