...
if ($state == 1) {
    $sql = "INSERT INTO awards (title) VALUES('$title')";
    $conn->query($sql);
    ...
    <div class="row pt-2">
        <div class="col-12 col-sm-5">
            <div class="form-group">
                <label>awards:</label>
                <input type="text" class="form-control form-control-user" id="title" name="title" aria-describedby="emailHelp" placeholder="Enter awards...">
            </div>
        </div>
    </div>
